...
If you want to collaborate please contact me on discord [@nepputty](https://discord.com/users/443757912276598784).
...
## 3. Creating Interactive Presets
...
* <ins>**Instance Locking</ins>** : Uses Linux Abstract Sockets (\0) to prevent multiple engine instances from running simultaneously.
* <ins>**Non-Persistent UI</ins>** : The Control Panel is designed to be hidden, not destroyed, allowing it to maintain state and reappear instantly from the tray.
* <ins>**Auto-Pathing</ins>** : The setup.sh script generates absolute paths for the launcher, ensuring the engine can be moved between directories without breaking the Mint Menu shortcut.
...
Performance mode doesn't work with html presets
